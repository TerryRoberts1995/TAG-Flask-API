...
class Blog(db.Model):
    ...
    userFk = db.Column(db.Integer, db.ForeignKey('user.id'), nullable=True)
...
class ArtistSchema(ma.Schema):
    class Meta:
        fields = ('id', 'username', 'motto', 'blogs', 'created_at', 'userFk')
    blogs = ma.Nested(multiple_blog_schema)
...
@app.route("/artist/<username>", methods=["GET"])
def get_specific_artist(username):
